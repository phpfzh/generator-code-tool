...
import com.ganjiangps.generator.tool.generate.Controller;
import com.ganjiangps.generator.tool.generate.Dao;
import com.ganjiangps.generator.tool.generate.Edit;
import com.ganjiangps.generator.tool.generate.Model;
import com.ganjiangps.generator.tool.generate.ModelXml;
import com.ganjiangps.generator.tool.generate.Service;
import com.ganjiangps.generator.tool.generate.ServiceImpl;
...
public class Generator extends BaseFrame {
	...
	protected void changeTextValue() {
		...
		this.daoText.setText(getPackageName() + "mapper"
				+ (analyzer != null ? "/" + analyzer.getModelName() + "Mapper.java" : ""));
	...
	private void generateListFile(String basePath) {
		if (StringUtils.isNotBlank(this.listText.getText())) {
			...
			FileUtils.createFile(
					basePath,
					listText.getText(),
					new com.ganjiangps.generator.tool.generate.List(analyzer.getTableComment(), analyzer.getModelName(), analyzer
